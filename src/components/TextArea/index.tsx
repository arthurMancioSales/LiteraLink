...
export function TextArea({ name, type = "", label, required }: PropTypes) {
    return (
        <div>
            ...
            <Field as="textArea" className="w-full min-h-[80px] max-h-[80px] p-2 rounded-md bg-light-tertiary drop-shadow-[2px_2px_2px_rgba(0,0,0,0.25)] dark:bg-dark-secondary dark:text-dark-text" type={type} name={name} />
